...
ActiveRecord::Schema.define(:version => 20120308031242) do
  ...
  add_index "aspect_memberships", ["aspect_id", "contact_id"], :name => "index_aspect_memberships_on_aspect_id_and_contact_id"
